...
public class RESTController {
    ...
    public @ResponseBody boolean addUser(ModelMap model,
    ...
    public @ResponseBody boolean removeUser(ModelMap model, @RequestParam(value = "userId", required = true) String userId) {
    ...
    public @ResponseBody boolean removeProduct(ModelMap model, @RequestParam(value = "articule", required = true) String articule) {
